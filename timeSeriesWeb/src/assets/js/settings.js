...
, , , function(t, e, n) {
    var r = n(2)
      ...
      , a = n(41)
      , u = function(t, e, n) {
        var s, l, f, p, h = t & u.F, d = t & u.G, v = t & u.S, y = t & u.P, m = t & u.B, g = d ? r : v ? r[e] || (r[e] = {}) : (r[e] || {}).prototype, b = d ? o : o[e] || (o[e] = {}), x = b.prototype || (b.prototype = {});
        for (s in d && (n = e),
        n)
            f = ((l = !h && g && void 0 !== g[s]) ? g : n)[s],
            p = m && l ? a(f, r) : y && "function" == typeof f ? a(Function.call, f) : f,
            g && c(g, s, f, t & u.U),
            b[s] != f && i(b, s, p),
            y && x[s] != f && (x[s] = f)
    };
...
, function(t, e, n) {
    ...
    (t.exports = function(t, e, n, a) {
        ...
        t[e] !== n && (u && (i(n, c) || o(n, c, t[e] ? "" + t[e] : s.join(String(e)))),
...
, , , , , function(t, e, n) {
    "use strict";
    var r, o, i = n(82), c = RegExp.prototype.exec, a = String.prototype.replace, u = c, s = (r = /a/,
    o = /b*/g,
    c.call(r, "a"),
    c.call(o, "a"),
...
, , function(t, e, n) {
    ...
    r(r.P + r.F * n(3)((function() {
        ...
        slice: function(t, e) {
            ...
            for (var o = c(t, n), s = c(e, n), l = a(s - o), f = new Array(l), p = 0; p < l; p++)
...
, function(t, e, n) {
    ...
    n(59)("replace", 2, (function(t, e, n, d) {
        ...
        , function(t, e) {
            ...
            for (var x, S = "", w = 0, O = 0; O < g.length; O++) {
                b = g[O];
                for (var k = String(b[0]), j = s(l(c(b.index), p.length), 0), L = [], E = 1; E < b.length; E++)
                    L.push(void 0 === (x = b[E]) ? x : String(x));
                var A = b.groups;
                if (h) {
                    var P = [k].concat(L, j, p);
                    void 0 !== A && P.push(A);
...
, function(t, e, n) {
    var r = n(7)
      ...
      , a = function() {}
      , u = function() {
        var t, e = n(48)("iframe"), r = i.length;
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n, y, m, g, b) {
        ...
        }, k = e + " Iterator", j = m == d, L = !1, E = t.prototype, A = E[f] || E["@@iterator"] || m && E[m], P = A || O(m), T = m ? j ? O("entries") : P : void 0, _ = "Array" == e && E.entries || A;
        if (_ && (w = l(_.call(new t))) !== Object.prototype && w.next && (s(w, k, !0),
...
, , , , , , function(t, e, n) {
    (function(t, e, n) {
        !function(t) {
            "use strict";
            var r, o = /^[a-z]+:/, i = /[-a-z0-9]+(\.[-a-z0-9])*:\d+/i, c = /\/\/(.*?)(?::(.*?))?@/, a = /^win/i, u = /:$/, s = /^\?/, l = /^#/, f = /(.*\/)/, p = /^\/{2,}/, h = /(^\/?)/, d = /'/g, v = /%([ef][0-9a-f])%([89ab][0-9a-f])%([89ab][0-9a-f])/gi, y = /%([cd][0-9a-f])%([89ab][0-9a-f])/gi, m = /%([0-7][0-9a-f])/gi, g = /\+/g, b = /^\w:$/, x = /[^/#?]/, S = "undefined" == typeof window && void 0 !== e && !0, w = !S && t.navigator && t.navigator.userAgent && ~t.navigator.userAgent.indexOf("MSIE"), O = S ? t.require : null, k = {
                protocol: "protocol",
                host: "hostname",
                port: "port",
                path: "pathname",
            ...
            function L() {
                return S ? r = r || "file://" + (n.platform.match(a) ? "/" : "") + O("fs").realpathSync(".") : "about:srcdoc" === document.location.href ? self.parent.document.location.href : document.location.href
            }
            function E(t) {
                return encodeURIComponent(t).replace(d, "%27")
            }
            function A(t) {
                return (t = (t = (t = t.replace(g, " ")).replace(v, (function(t, e, n, r) {
            ...
            function T(t, e) {
                !function(t, e, n) {
                    var r, a, d;
                    e = e || L(),
                    S ? r = O("url").parse(e) : (r = document.createElement("a")).href = e;
                    var v, y, m = (y = {
                        path: !0,
                        query: !0,
                        hash: !0
                    },
                    (v = e) && o.test(v) && (y.protocol = !0,
                    y.host = !0,
                    i.test(v) && (y.port = !0),
                    c.test(v) && (y.user = !0,
                    y.pass = !0)),
                    y);
                    for (a in d = e.match(c) || [],
                    k)
                        m[a] ? t[a] = r[k[a]] || "" : t[a] = "";
                    if (t.protocol = t.protocol.replace(u, ""),
                    t.query = t.query.replace(s, ""),
                    t.hash = A(t.hash.replace(l, "")),
                    t.user = A(d[1] || ""),
                    t.pass = A(d[2] || ""),
                    t.port = j[t.protocol] == t.port || 0 == t.port ? "" : t.port,
                    !m.protocol && x.test(e.charAt(0)) && (t.path = e.split("?")[0].split("#")[0]),
                    !m.protocol && n) {
                        var g = new T(L().match(f)[0])
                          , b = g.path.split("/")
                          , E = t.path.split("/")
            ...
            ,
            T.prototype.encode = E,
            T.prototype.decode = A,
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        return function(e) {
            for (var n, a = i(e), u = o(a), s = u.length, l = 0, f = []; s > l; )
                n = u[l++],
...
, function(t, e, n) {
    ...
    : function(t) {
      ...
      , K = function(t, e, n) {
        ...
        e = w(e, !0),
        g(n),
        o($, e) ? (n.enumerable ? (o(t, q) && t[q][e] && (t[q][e] = !1),
        n = k(n, {
            enumerable: O(0, !1)
        })) : (o(t, q) || _(t, q, O(1, {})),
        t[q][e] = !0),
      ...
      , Y = function(t) {
        ...
        return !(this === G && o($, t) && !o(z, t)) && (!(e || !o(this, t) || !o($, t) || o(this, q) && this[q][t]) || e)
    }
      , X = function(t, e) {
        if (t = S(t),
        e = w(e, !0),
        t !== G || !o($, e) || o(z, e)) {
            var n = T(t, e);
            return !n || !o($, e) || o(t, q) && t[q][e] || (n.enumerable = !0),
            n
        }
    }
      , Z = function(t) {
        for (var e, n = C(S(t)), r = [], i = 0; n.length > i; )
            o($, e = n[i++]) || e == q || e == u || r.push(e);
        return r
    }
      , tt = function(t) {
        for (var e, n = t === G, r = C(n ? z : S(t)), i = [], c = 0; r.length > c; )
            !o($, e = r[c++]) || n && !o(G, e) || i.push($[e]);
        return i
    };
    U || (a((I = function() {
    ...
    n(60).f = Y,
    E.f = tt,
    i && !n(33) && a(G, "propertyIsEnumerable", Y, !0),
    d.f = function(t) {
        return W(h(t))
    }
    ),
...
, function(t, e, n) {
    for (var r = n(136), o = n(39), i = n(19), c = n(2), a = n(10), u = n(46), s = n(0), l = s("iterator"), f = s("toStringTag"), p = u.Array, h = {
        CSSRuleList: !0,
        ...
        var y, m = d[v], g = h[m], b = c[m], x = b && b.prototype;
        if (x && (x[l] || a(x, l, p),
        x[f] || a(x, f, m),
        u[m] = p,
        g))
...
, function(t, e, n) {
    ...
    var r = n(41)
      ...
      , s = n(240)
      , l = n(241);
    o(o.S + o.F * !n(242)((function(t) {
        Array.from(t)
    }
    )), "Array", {
        from: function(t) {
            var e, n, o, f, p = i(t), h = "function" == typeof this ? this : Array, d = arguments.length, v = d > 1 ? arguments[1] : void 0, y = void 0 !== v, m = 0, g = l(p);
            ...
            null == g || h == Array && a(g))
                ...
                for (f = g.call(p),
                n = new h; !(o = f.next()).done; m++)
                    s(n, m, y ? c(f, v, [o.value, m], !0) : o.value);
            return n.length = m,
            n
        }
    })
...
, , , , , , , , , , , , , , , , , , , , , , , , , , function(t, e, n) {
    ...
    var c = new (n.n(r).a)
      ...
      , f = void 0
      // TODO : remove this comment if using setting button
      , p = function() {
      ...
      , h = function() {
        ...
        document.querySelectorAll(".js-settings-toggle").forEach((function(e) {
      ...
      , d = function() {
        document.querySelector(u).querySelectorAll("input[type=radio]").forEach((function(t) {
      ...
      , y = function() {
        for (var t = 0, e = Object.entries(x()); t < e.length; t++) {
            var n = o(e[t], 2)
              , r = n[0]
              , i = n[1]
              , c = i || s[r];
      ...
      , m = function() {
        setTimeout((function() {
            w("visited") || (document.querySelector(u).classList.toggle("open"),
            O("visited", !0))
        }
        ), 1e3)
    }
      ...
      , b = function(t, e) {
        if ("theme" === t) {
            var n = "dark" === e ? "dark" : "light";
            document.querySelector(".js-stylesheet").setAttribute("href", "assets/css/".concat(n, ".css")),
            f && f !== n && window.location.replace(window.location.pathname),
            f = n
        }
    ...
    var j = new MutationObserver((function() {
        document.body && (Object.keys(c.query).length > 0 ? (S(),
        Object.entries(c.query).forEach((function(t) {
            var e = o(t, 2)
              , n = e[0]
              , r = e[1];
            l[n] && l[n].includes(r) && (b(n, r),
            O(n, r))
        }
        ))) : g(),
        j.disconnect())
